...
const scripts = (() => {
  ...
  const _renderTitle = () => {
    const chosenProject = _isDefaultProject();
  ...
  const _addProjectListeners = () => {
    ...
    projectLefts.forEach((left) =>
      left.addEventListener("click", _chooseProject)
    );

    const editProjects = document.getElementsByName("edit-project");
    editProjects.forEach((edit) =>
      edit.addEventListener("click", (e) => {
        if (
          document.querySelector(".new-project") === null &&
          document.querySelector(".edit-box") === null
        ) {
          _editProject(e);
        }
      })
    ...
    deleteProjects.forEach((del) =>
      del.addEventListener("click", _deleteProject)
    );
  };
    ...
    editTodos.forEach((edit) =>
      edit.addEventListener("click", (e) => {
        if (
          ...
          document.querySelector(".edit-box") === null &&
          document.querySelector(".new-todo") === null
        ) {
          _editTodo(e);
        }
      })
  ...
  const _editTodo = (e) => {
    ...
    const chosenProject = _isDefaultProject();
    const project = chosenProject.currentProject[todo];
